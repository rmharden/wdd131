...
const exercises = [
    ...
    },
    {
        ...
        description: 'Stand with weights at your sides, palms forward. Keeping your arms straight, raise the weights out to shoulder height. Pause briefly, then slowly lower them back down.',
        order: 32,
    ...
    },
    {
        ...
        count: '4',
        alternate: "all back exercises",
        description: 'Start with weights overhead. Bend your elbows and pull them down toward your sides, squeezing your shoulder blades. Return to the starting position.',
        order: 33,
        tags: ['back', 'arms', 'muscular', 'weights', 'dumbbells', 'core', 'calisthenics']
    },
    {
